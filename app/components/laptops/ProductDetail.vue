            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbLink :href="`/laptops/categories/${category?.slug}`">
                                {{ category?.name }}
                            </BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbLink :href="`/laptops/categories/${category?.slug}/${subcategory?.slug}`">
                                {{ subcategory?.name }}
                            </BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
            ...
            <div class="mt-12 bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                ...
                <div class="bg-gradient-to-r from-pink-500 to-pink-600 px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <NuxtLink v-if="category" :to="`/laptops/categories/${category.slug}`"
                ...
                <div class="p-6 bg-gray-50">
                    <div v-if="similarProducts.length > 0"
                        ...
                        <div v-for="similarProduct in similarProducts" :key="similarProduct.id"
                            ...
                            <LaptopsProductCard :product="similarProduct" />
                        </div>
                    </div>
...
<script setup lang="ts">
    ...
    import brandsData from '~/assets/data/Laptops/brand.json';
