<template>
    <div class="min-h-screen bg-linear-to-br from-blue-50 via-white to-blue-50">
        ...
        <div class="max-w-lg mx-auto px-4 sm:px-6 py-8 sm:py-12">
            ...
            <!-- Payment Success -->
            <div v-else-if="paymentStatus === 'paid'" class="bg-green-50 border-2 border-green-200 rounded-2xl p-8 text-center">
            ...
            <div v-else class="space-y-4">
                ...
                <div class="bg-white rounded-2xl border-2 border-blue-200 shadow-xl p-6 text-center">
                    ...
                    <div class="inline-flex items-center gap-2 bg-gray-50 px-5 py-2.5 rounded-xl border border-gray-200">
                ...
                <!-- Checking indicator -->
                <div v-if="isPolling" class="flex items-center justify-center gap-2 text-blue-600 text-sm">
